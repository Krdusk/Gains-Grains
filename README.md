...
- Create a folder named `gains-and-grains`.  
...
- Open: http://localhost/gains-and-grains  

## Project Structure
The project is organized into the following components:

- `htdocs/G_G/` — Main project directory  
- `css/` — Stylesheets for layout and design  
- `js/` — JavaScript files for interactivity  
- `php/` — Backend scripts and database handling  
- `database/` — SQL file for database setup  

Ensure all files are placed correctly to avoid errors when running the system.
